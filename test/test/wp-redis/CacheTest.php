...
class CacheTest extends WPRedisTestCase {
	...
	public function test_miss() {
		...
		$this->assertEquals( array( 'get' => 1 ), $this->cache->redis_calls );
	}
	...
	public function test_set() {
		...
		$this->assertEquals( array( 'set' => 2 ), $this->cache->redis_calls );
	}
	...
	public function test_get_already_exists_internal() {
		...
		$this->assertEquals( array( 'set' => 1 ), $this->cache->redis_calls );
	...
	public function test_get_missing_persistent() {
		...
		$this->cache->get( $key );
		$this->cache->get( $key );
		$this->assertEquals( array( 'get' => 2 ), $this->cache->redis_calls );
	}
	...
	public function test_get_string_values_persistent_cache() {
		...
		$this->assertEquals( array( 'get' => 4 ), $this->cache->redis_calls );
	}
	...
	public function test_cache_key() {
		$key                             = rand_str();
		$group                           = 'default';
		$true_key                        = WP_CACHE_KEY_SALT . json_encode( array( '', $group, $key ) );
	...
	public function test_get_force() {
		...
		$this->assertEquals( array( 'get' => 1, 'set' => 1 ), $this->cache->redis_calls );
	}
	...
	public function test_replace() {
		...
		$this->assertEquals( $val2, $this->cache->get( $key ) );
		$this->assertEquals( array( 'get' => 1, 'set' => 3 ), $this->cache->redis_calls );
	}
	...
	public function test_incr() {
		...
		$this->assertEquals( array( 'evalSha' => 3, 'set' => 1 ), $this->cache->redis_calls );
	}
	...
	public function test_incr_separate_groups() {
		...
		$this->assertEquals( array( 'evalSha' => 6, 'set' => 2 ), $this->cache->redis_calls );
	}
	...
	public function test_incr_never_below_zero() {
		...
		$this->assertEquals( array( 'evalSha' => 1, 'set' => 1 ), $this->cache->redis_calls );
	}
	...
	public function test_decr() {
		...
		$this->assertEquals( 0, $this->cache->get( $key ) );
		$this->assertEquals( array( 'evalSha' => 4, 'set' => 2 ), $this->cache->redis_calls );
	}
	...
	public function test_decr_separate_groups() {
		...
		$this->assertEquals( 0, $this->cache->get( $key, $group1 ) );
		$this->assertEquals( 0, $this->cache->get( $key, $group2 ) );
		$this->assertEquals( array( 'evalSha' => 8, 'set' => 4 ), $this->cache->redis_calls );
	}
